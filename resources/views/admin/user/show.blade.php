  ...
  <div class="col-md-3">
    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        ...
        @if(!$user->active)
        <a style="display: none;" href="{{ route('admin.user_send', ['id' => $user->id]) }}" class="btn btn-warning btn-block"><b>Send Active Account</b></a>
        @endif
      </div>
      <!-- /.box-body -->
    </div>
                      ...
                      <table class="table table-striped" style="margin-bottom: 0; background-color: #fff;">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" style="vertical-align: middle;">Thương<br>Hiệu</th>
