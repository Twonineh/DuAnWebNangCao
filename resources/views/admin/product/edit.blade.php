...
<form id="productForm" action="{{ route('admin.product.update', ['id' => $product->id]) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="sku_code">Thương Hiệu <span class="text-red">*</span></label>
                <input type="text" name="sku_code" class="form-control" id="sku_code" placeholder="Thương Hiệu" required autocomplete="off" value="{{ $product->sku_code }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="monitor">Xuất Xứ <span class="text-red">*</span></label>
                <input type="text" name="monitor" class="form-control" id="monitor" placeholder="Xuất Xứ" required autocomplete="off" value="{{ $product->monitor }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="front_camera">Khối lượng <span class="text-red">*</span></label>
                <input type="text" name="front_camera" class="form-control" id="front_camera" placeholder="Khối lượng" required autocomplete="off" value="{{ $product->front_camera }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="rear_camera">Thành Phần <span class="text-red">*</span></label>
                <input type="text" name="rear_camera" class="form-control" id="rear_camera" placeholder="Thành Phần" required autocomplete="off" value="{{ $product->rear_camera }}">
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="CPU">Ngày Sản Xuất <span class="text-red">*</span></label>
                <input type="text" name="CPU" class="form-control" id="CPU" placeholder="Ngày Sản Xuất" required autocomplete="off" value="{{ $product->CPU }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="GPU">Hạn Sử Dụng <span class="text-red">*</span></label>
                <input type="text" name="GPU" class="form-control" id="GPU" placeholder="Hạn Sử Dụng" required autocomplete="off" value="{{ $product->GPU }}">
              </div>
            </div>
          </div>
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Thông Tin Sản Phẩm Và Giá Sản Phẩm</h3>
      <div class="box-tools">
        <!-- This will cause the box to collapse when clicked -->
        <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
      </div>
          ...
          <div class="box box-solid box-default collapsed-box" style="margin-bottom: 5px;">
            ...
            <div class="box-body" style="display: none;">
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="color_{{ $product_detail->id }}">Loại <span class="text-red">*</span></label>
    ...
    <div class="text-center box-footer">
      <button class="add btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Thêm Loại Sản Phẩm</button>
    </div>
  </div>
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active" style="display: none";><a href="#product-information" data-toggle="tab">Cấu Hình Chi Tiết</a></li>
      <li><a href="#product-introduction" data-toggle="tab" style="font-size: 18px;">Bài Viết Sản Phẩm</a></li>
    </ul>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" name="product_details[{?}][color]" class="form-control color" id="color_{?}" placeholder="Loại" required autocomplete="off">
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
