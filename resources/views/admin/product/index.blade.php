          ...
          <table id="product-table" class="table table-hover" style="width:100%; min-width: 985px;">
            <thead>
              <tr>
                ...
                <th data-orderable="false" data-width="85px">Thương Hiệu</th>
                <th data-orderable="false">Tên Sản Phẩm</th>
                <th data-width="90px">Loại Sản Phẩm</th>
                <th data-width="85px" style="display: none;">Hệ Điều Hành</th>
                <th data-width="60px" style="display: none;">Đánh Giá</th>
            ...
            <tbody>
              @foreach($products as $product)
                <tr>
                  ...
                  <td style="display: none;">{{ $product->OS }}</td>
                  <td style="display: none;">{{ $product->rate }}/5 Điểm</td>
