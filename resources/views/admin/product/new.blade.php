          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="sku_code" class="form-control" id="sku_code" placeholder="Thương Hiệu" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4" >
              <div class="form-group">
          ...
          <div class="row" >
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="monitor" class="form-control" id="monitor" placeholder="Xuất Xứ" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="front_camera">Khối lượng <span class="text-red">*</span></label>
                <input type="text" name="front_camera" class="form-control" id="front_camera" placeholder="Khối lượng" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="rear_camera">Thành Phần <span class="text-red">*</span></label>
                <input type="text" name="rear_camera" class="form-control" id="rear_camera" placeholder="Thành Phần" required autocomplete="off">
              </div>
            </div>
          </div>
          <div class="row" >
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="CPU" class="form-control" id="CPU" placeholder="Ngày Sản Xuất" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="GPU">Hạn Sử Dụng <span class="text-red">*</span></label>
                <input type="text" name="GPU" class="form-control" id="GPU" placeholder="Hạn Sử Dụng" required autocomplete="off">
              </div>
            </div>
          </div>
