    ...
    <section class="section-product">
      <div class="section-header">
        ...
        <div class="section-sub-title">
          <div class="sku-code">Thương Hiệu: <i>{{ $data['product']->sku_code }}</i></div>
            ...
            <div class="col-lg-3 col-md-4">
              <div class="infomation-detail">
                ...
                <div class="infomation-content">
                  <ul>
                    <li><label>Xuất Xứ:</label>{{ $data['product']->monitor ?: 'Đang Cập Nhật...' }}</li>
                    <li><label>Khối Lượng:</label>{{ $data['product']->front_camera ?: 'Đang Cập Nhật...' }}</li>
                    <li><label>Thành Phần:</label>{{ $data['product']->rear_camera ?: 'Đang Cập Nhật...' }}</li>
                    <li style="display: none;"><label>Ram:</label>{{ $data['product']->RAM != 0 ? $data['product']->RAM.' GB' : 'Đang Cập Nhật...' }}</li>
                    <li style="display: none;"><label>Bộ Nhớ Trong:</label>{{ $data['product']->ROM != 0 ? $data['product']->ROM.' GB' : 'Đang Cập Nhật...' }}</li>
                    <li><label>Ngày Sản Xuất:</label>{{ $data['product']->CPU ?: 'Đang Cập Nhật...' }}</li>
                    <li><label>Hạn Sử Dụng:</label>{{ $data['product']->GPU ?: 'Đang Cập Nhật...' }}</li>
                    <li style="display: none;"><label>Dung Lượng Pin:</label>{{ $data['product']->pin ?: 'Đang Cập Nhật...' }}</li>
                    <li style="display: none;"><label>Hệ Điều Hành:</label>{{ $data['product']->OS ?: 'Đang Cập Nhật...' }}</li>
                  </ul>
                </div>
                <div class="more-infomation">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#more-infomation" style="display: none;">
