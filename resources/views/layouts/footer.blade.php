<footer class="footer">
        ...
        <div class="col-md-3 col-sm-4 col-xs-6 col-ssm">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <p><b><i class="fas fa-mobile-alt"></i> Hotline:</b> <a href="tel:(+84) 967 999 999">(+84) 987586700</a></p>
              <p><b><i class="fas fa-envelope"></i> Email:</b> <a href="mailto:phonestore@gmail.com" rel="nofollow">t.anh2509@gmail.com</a></p>
  ...
  <div class="footer-bottom">
    <div class="copyright text-center">
      Copyright &copy 2024 TheAnh. All rights reserved.
    </div>
  </div>
</footer>
